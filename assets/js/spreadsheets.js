...
const query3 = encodeURIComponent('SELECT Y WHERE N=37')
const query4 = encodeURIComponent('SELECT D WHERE C=37')
const query5 = encodeURIComponent('SELECT H WHERE C=37')
const query6 = encodeURIComponent('SELECT M WHERE C=37')
...
const url4 = `https://cors-anywhere.herokuapp.com/${base}&sheet=${sheetName2}&tq=${query4}`
const url5 = `https://cors-anywhere.herokuapp.com/${base}&sheet=${sheetName2}&tq=${query5}`
const url6 = `https://cors-anywhere.herokuapp.com/${base}&sheet=${sheetName2}&tq=${query6}`
data1 = []
data2 = []
data3 = []
data4 = []
